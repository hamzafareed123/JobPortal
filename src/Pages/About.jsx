    ...
    <>
      <section className="relative h-[90vh] w-full mt-0 overflow-hidden">
        ...
        <div className="relative z-10 w-1/2 flex flex-col justify-center items-center h-full text-center px-4 ml-10">
          <h1 className="text-6xl font-extrabold text-white uppercase mb-4 p-3">
      ...
      <div className="w-full flex flex-col lg:flex-row items-center gap-10 px-8 py-16 mt-15">
        ...
        <div className="flex-1 ml-5">
          ...
          <p className="text-gray-600 mb-8 leading-relaxed">
            ...
            companies. Whether you're looking to start your career or expand
            your team, we provide the tools, resources, and network to make it
            happen. From AI-powered job matching to verified employer profiles,
            we ensure every opportunity is transparent and tailored to your
            goals.
          </p>
          ...
          <ul className="space-y-3 mb-6">
            ...
            <li className="flex items-center gap-2">
              <FaCheckCircle className="text-green-500" /> Verified companies
